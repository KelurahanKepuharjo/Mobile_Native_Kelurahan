...
public class ditolakFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recyclerDitolak);
    ...
    public static class CustomAdapterStatus extends RecyclerView.Adapter<ditolakFragment.CustomAdapterStatus.ViewHolder> {
        ...
        @NonNull
        @Override
        public ditolakFragment.CustomAdapterStatus.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = layoutInflater.inflate(R.layout.item_status_ditolak, parent, false);
            return new ditolakFragment.CustomAdapterStatus.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull ditolakFragment.CustomAdapterStatus.ViewHolder holder, int position) {
